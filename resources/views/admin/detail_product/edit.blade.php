    ...
    <div class="col-sm-12" style="margin-bottom:20%">
        <div class="card">
            <div class="box-body" style="padding-bottom:50px">
                <form id="fileUploadForm" class="text-left border border-light p-5" action="{{route('detail-product.update', $data->id)}}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <select name="kelas" class="select2 form-control" id="default-select">
                                <option value="Dasar" {{$data->kelas == 'Dasar' ? 'selected' : ''}}>Dasar</option>
                                <option value="Pokok" {{$data->kelas == 'Pokok' ? 'selected' : ''}}>Pokok</option>
                        </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="datepicker" class="form-control  " name="panen" id="panen" value="{{$data->panen}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            id="sisa" value="{{$data->sisa}}">
                        <input type="hidden" name="sisa" class="sisa" value="{{$data->sisa}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            id="produksi" value="{{$data->produksi}}">
                        <input type="hidden" name="produksi" class="produksi" value="{{$data->produksi}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            id="masuk" value="{{$data->masuk}}">
                        <input type="hidden" name="masuk" class="masuk" value="{{$data->masuk}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            id="keluar_komersial" value="{{$data->keluar_komersial}}">
                        <input type="hidden" name="keluar_komersial" class="keluar_komersial" value="{{$data->keluar_komersial}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            id="keluar_nonkomersial" value="{{$data->keluar_nonkomersial}}">
                        <input type="hidden" name="keluar_nonkomersial" class="keluar_nonkomersial" value="{{$data->keluar_nonkomersial}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="month" class="form-control" name="bulan" id="bulan" value="{{$data->bulan}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="tahun_datepicker" class="form-control  " name="tahun" id="tahun" value="{{$data->tahun}}">
                        </div>
                    </div>
