    ...
    <div class="col-sm-12" style="margin-bottom:20%">
        <div class="card">
            <div class="box-body" style="padding-bottom:50px">
                <form id="fileUploadForm" class="text-left border border-light p-5" action="{{route('product.update', $data->id)}}" method="POST"
                    ...
                    <div class="form-group">
                        ...
                        <input type="hidden" class="js-inverse js-danger js-warning js-info js-single js-switch js-dynamic-state js-default js-primary js-success js-single js-switch js-dynamic-state js-default js-primary js-success">
