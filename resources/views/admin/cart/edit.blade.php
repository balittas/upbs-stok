    ...
    <div class="col-sm-12" style="margin-bottom:20%">
        <div class="card">
            <div class="box-body" style="padding-bottom:50px">
                <form id="fileUploadForm" class="text-left border border-light p-5" action="{{route('cart.update',$data->id)}}" method="POST"
                        ...
                        <div class="input-group">
                            <span class="input-group-prepend">
                                ...
                                <select name="detail_product_id" class="select2 form-control" id="default-select">
                                        @foreach($detail_products as $p)
                                        <option value="{{$p->id}}"
                                            {{$data->detail_product_id == $p->id ? 'selected' : ''}}
                        ...
                        <div class="input-group">
                            <span class="input-group-prepend">
                                ...
                                <select name="transaction_id" class="select2 form-control" id="default-select">
                                        ...
                                        <option value="{{$u->id}}"
                                            {{$data->transaction_id == $u->id ? 'selected' : ''}}
                                        >{{$u->id}}</option>
                                        @endforeach
                                </select>
                        </div>
