        ...
        <div class="page-wrap">
            <div class="app-sidebar colored">
                <div class="sidebar-header">
                    <a class="header-brand" href="#">
                        <div class="logo-img">
                            <img src="{{url('assets/admin/img/logo/logo.png')}}" class="header-brand-img" alt="lavalite"
                                width="500%">
                        </div>
                    </a>
                ...
                <div class="sidebar-content">
                    <div class="nav-container">
                        <nav id="main-menu-navigation" class="navigation-main">
                            ...
                            <div
                                class="nav-item has-sub {{Route::is('product.index') || Route::is('product.create') || Route::is('product.edit') || Route::is('detail-product.index') || Route::is('detail-product.create') || Route::is('detail-product.edit') || Route::is('product-category.index') || Route::is('product-category.create') || Route::is('product-category.edit')  ? 'open' : ''}}">
                                <a href="javascript:void(0)"><i class="mdi mdi-folder"></i><span> Data Produk</span></a>
                                <div class="submenu-content">
                                    <a href="{{route('product.index')}}"
                                        class="menu-item {{Route::is('product.index') || Route::is('product.create') || Route::is('product.edit')  ? 'active' : ''}}"><i
                                            class="mdi mdi-apps"></i> Produk</a>
                                </div>
                                <div class="submenu-content ">
                                    <a href="{{route('detail-product.index')}}"
                                        class="menu-item {{Route::is('detail-product.index') || Route::is('detail-product.create') || Route::is('detail-product.edit')  ? 'active' : ''}}"><i
                                            class="mdi mdi-archive"></i> Detail Produk</a>
                                </div>
                                <div class="submenu-content ">
                                    <a href="{{route('product-category.index')}}"
                                        class="menu-item {{Route::is('product-category.index') || Route::is('product-category.create') || Route::is('product-category.edit')  ? 'active' : ''}}"><i
                                            class="mdi mdi-folder-multiple"></i> Kategori Produk</a>
                                </div>
                            </div>
                            <div
                            ...
                            <div class="nav-item {{Route::is('cart.index') || Route::is('cart.create') || Route::is('cart.edit')  ? 'active' : ''}}">
                                <a href="{{route('cart.index')}}"><i class="mdi mdi-cart"></i>
                                    <span>Keranjang</span></a>
                            </div>
                            <div class="nav-item {{Route::is('transaction.index') || Route::is('transaction.create') || Route::is('transaction.edit')  ? 'active' : ''}}">
                                <a href="{{route('transaction.index')}}"><i class="mdi mdi-cash-usd"></i>
            ...
            <footer class="footer">
                <div class="w-100 clearfix">
                    <span class="text-center text-sm-left d-md-inline-block">Copyright © 2021 </span>
                </div>
            </footer>
