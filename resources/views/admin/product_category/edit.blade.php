    ...
    <div class="col-sm-12" style="margin-bottom:20%">
        <div class="card">
            <div class="box-body" style="padding-bottom:50px">
                <form id="fileUploadForm" class="text-left border border-light p-5" action="{{route('product-category.update', $data->id)}}" method="POST"
...
<script>
    ...
    $(function () {
        uploadSuccess = function () {
            ...
            $.toast({
                heading: 'Success',
                text: 'Kategori Produk berhasil diupdate',
