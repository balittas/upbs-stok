                    ...
                    <div class="checkout_details_area clearfix">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <input type="number" name="no_hp" class="form-control" id="phone_number" min="0" value="" required>
                            </div>
                            <div class="col-12 mb-4">
                    ...
                    <div class="checkout-content">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <b>Lakukan transfer Total Produk dengan jumlah Rp. {{number_format($sub_total, 2)}} ke rekening
                                1335735347 (BANK BNI) a.n Ichsan Ashiddiqi</b>
                        </div>
                        <br>
                        <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <input accept="image/*" onchange="loadFileProduk(event)" id="total_produk" type="file" class="form-control" name="bukti_transfer_produk" required>
                        </div>
                        <br>
                        <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <input accept="image/*" onchange="loadFileOngkir(event)" id="total_ongkir" type="file" class="form-control" name="bukti_transfer_ongkir" required>
                        </div><br>
